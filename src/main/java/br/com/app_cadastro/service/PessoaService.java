...
public class PessoaService {
	...
	public void delete(Long id) {
		Pessoa entity = pessoaRepository.findById(id).orElseThrow(
				() -> new ResourceNotFoundException("Não foi possível encontrar o registro no Banco de Dados"));
		
		pessoaRepository.delete(entity);
	}

	public List<PessoaVO> buscarTodos() {
		return DozerConverter.parseListObject(pessoaRepository.findAll(), PessoaVO.class);
	}
	...
	public List<PessoaVO> buscarPorNome(String nome) {
		return DozerConverter.parseListObject(pessoaRepository.findByNome(nome), PessoaVO.class);
